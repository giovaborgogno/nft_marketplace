...
const NFTCard = ({ nft, onProfilePage }) => {
  ...
  return (
    <Link href={{ pathname: '/nft-details', query: nft }}>
      <div className="flex-1 min-w-225 max-w-max xs:max-w-none sm:w-full sm:min-w-155 minmd:min-w-256 minlg:min-w-327 dark:bg-nft-black-3 bg-white rounded-2xl p-4 m-4 sm:mx-0 minlg:m-8 sm:my-2  cursor-pointer shadow-md">
